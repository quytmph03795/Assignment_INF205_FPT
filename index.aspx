    ...
    <div>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <center>
                            ...
                            | <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/dangky.aspx" ForeColor="White" OnClick="LinkButton1_Click1" Font-Size="Small">ĐĂNG KÝ</asp:LinkButton>
        ...
        <div id="bodycenter" style="width:100%; height:500px;">
            ...
            <center>
                ...
                <asp:Label ID="Label1" runat="server" CssClass="textlabel" Text="Wesbite đang cập nhật, quay lại sau." ForeColor="#FF3300"></asp:Label>
